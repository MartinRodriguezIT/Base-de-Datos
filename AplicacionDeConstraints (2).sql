...
alter table realiza add constraint fk_realizaTOR foreign key (idTorneo) references torneos(idTorneo);
...
alter table torneoInscriptos add constraint fk_torneoInscri foreign key (idTorneo) references torneos(idTorneo);
